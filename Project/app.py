...
''', (SrNo, name_match_score, uid_match_score, final_address_match_score, overall_score, final_remarks, document_type, accepted_rejected))
            ...
            return jsonify({"error": "User with this SrNo already exists"}), 409
        finally:
            conn.close()
...
classifier = YOLO(r"C:\Users\ramre\OneDrive\Desktop\infosys_project\classification_model\runs\classify\train17\weights\best.pt")
detector = YOLO(r"C:\Users\ramre\OneDrive\Desktop\dataset\runs\detect\val2")
reader = Reader(['en'])
